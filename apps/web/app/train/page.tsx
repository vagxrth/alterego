                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-gray-500">
                          Choose a memorable name (1-100 characters)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-gray-500">
                          Specify the gender for better model accuracy
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-gray-500">
                          Helps improve model accuracy for facial features
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="md:col-span-2">
                        ...
                        <FormDescription className="text-gray-500">
                          Provide a URL to your training data ZIP file containing high-quality images
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border border-gray-700 bg-gray-800/30 p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription className="text-gray-500">
                          Check this if the person in the training images has no hair or very short hair. 
                          This helps the model understand hair-related features better.
                        </FormDescription>
                      </div>
                    </FormItem>
                  )}
